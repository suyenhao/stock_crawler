# -*- coding: utf-8 -*-
"""
Created on Fri Aug 13 20:50:23 2021
...
ax.set_title(stock_symbol+ "K線圖 ("+ dates[0] +" ~"+ date[1] +")")
#子圖(ax)
mpf.candlestick2_ochl(ax, open_price, close_price, high, low, width=0.5,
...
ax.grid=(True)
#子圖(ax2)
mpf.volume_overlay(ax2, open_price, close_price, volume, width=0.5,
